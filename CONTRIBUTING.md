...
5. Test meaningful logic and edge cases with XCTest, and assert every accessibility promise the component makes with ViewInspector (`AccessibilityTests.swift`). Check the UI using the [accessibility review](docs/ACCESSIBILITY.md).
